...
const Home = () => {
  return (
    <div className='flex flex-col justify-center items-center p-4 gap-6 h-full w-full'>
      <div className='flex justify-center items-center w-full min-h-96 bg-gray-300 rounded-2xl'>
        ...
        <div className='flex flex-1 justify-center items-center rounded-2xl overflow-hidden'>
          <div className='h-96 bg-gray-500 w-full'>card</div>
        </div>
      </div>
      <div 
        className='flex flex-col justify-center items-center gap-4 p-1 ml-4 w-full bg-gray-300 h-full
        '>
