...
const PublishedCourses = () => {
  ...
  return (
    ...
    <div className='flex sm:flex-row flex-wrap justify-center items-start gap-3 sm:gap-4 mt-4 h-full p-4'>
    {(isCreator && isLoggedIn && publsihedCourses.length > 0) ?publsihedCourses.map((item, index) => 
      <div 
        ...
        <div 
          className='bg-gray-200 rounded-2xl h-30 w-35 sm:h-50 sm:w-50 flex justify-center items-center'
        >{item.settingsData.imageSrc}</div>
